...
La stéganographie permet dans une simple image ou un fichier audio de cacher une information ou une autre image. On peut par exemple appliquer un filtre sur une image faisant ressortir une certaine couleur afin d'y lire du texte.
\end{frame}
...
La cryptographie est utilisée pour crypter un message afin de le rende illisible par toute personne n'ayant pas l'autorisation de le consulter.
\end{frame}
